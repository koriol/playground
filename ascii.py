...
# run with:
# python ascii.py --file <image file required> --scale <scale factor> --out <output file> --cols <number of columns> --moreLevels
...
"""Given PIL Image, compute the average brightness"""
